...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        require(unlock_time <= now, "It is not time yet.");
        
        // 2: `distributed_shares` is less than the `total_shares`
        // Your code here!
        require(distributed_shares <= total_shares, "Total shares must be greater than or equal to distributed shares.");
        ...
        // Your code here!
        distributed_shares = (now - start_time) / 365 days * annnual_distribution;
